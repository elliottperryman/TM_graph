def preprocess_all(text_files, add_stop_words):
  ...
  corpora.MmCorpus.serialize('data/corpus',corpus)
  with open("data/x_train_rus", "wb") as fp:   #Pickling
      pickle.dump(x_train_rus, fp)
  with open("data/x_rus", "wb") as fp:   #Pickling
      pickle.dump(x_rus, fp)
  with open("data/all_sw", "wb") as fp:   #Pickling
