    ...
    def fit(self, corpus, dictionary, method=None, cluster_model=None):
        ...
        if method == 'LDA':
          if not self.ldamodel:
              ...
              print('hi')
              print([len(x) for x in x_train_rus_clear])
              processed_docs = x_train_rus_clear # np.array(x_train_rus_clear)
        ...
        # Default clustering method
          ...
          with open("data/x_rus", "rb") as fp:   # Unpickling
          ...
          def c_tf_idf(documents, m, ngram_range=(1, 1)):
            with open("data/all_sw", "rb") as fp:   # Unpickling
